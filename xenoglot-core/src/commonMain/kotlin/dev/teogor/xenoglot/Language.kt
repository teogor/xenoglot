...
sealed class Language : LanguageFamily {
  ...
  companion object {
     ...
     */
    fun getByCode(code: String): Language? = LanguageRegistry.getByCode(code)
     ...
     */
    fun getAllLanguages(): List<Language> = LanguageRegistry.getAllLanguages()
  }
  ...
  data object Norwegian : Language() {
    override val code: String = "no"

    override val name: String = "Norwegian"

    override val nativeName: String = "Norsk"
  }
