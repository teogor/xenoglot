...
/**
 * Represents the mapping of a country to its official languages.
 *
 * @property countryCode The ISO 3166-1 alpha-2 code of the country.
 * @property languageCodes A list of ISO 639-1 codes representing the official languages of the country.
 */
@Serializable
