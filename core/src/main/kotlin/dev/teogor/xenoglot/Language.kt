...
/**
 * Represents a language, inheriting from the `LanguageFamily` interface.
 *
 * @see LanguageFamily
 */
sealed class Language : LanguageFamily {
  ...
  /**
   * Retrieves the Java Locale representation of the language.
   *
   * @return The Java Locale object corresponding to the language code.
   */
  val locale: JavaLocale
    get() = JavaLocale(code)

  /**
   * Retrieves the language tag representation of the language.
   *
   * @return The language tag representing the language code.
   */
  override val languageTag: String
    get() = code

  /**
   * Converts the language to a `LanguageTag` object.
   *
   * @return The `LanguageTag` representation of the language.
   */
  override fun asLanguageTag(): LanguageTag = LanguageTag(code, this)

  /**
   * Retrieves the display name of the language in a given language.
   *
  ...
  /**
   * Retrieves the display name of the language in a given language code.
   *
   * @param languageCode The language code in which to display the name.
   *
   * @return The display name of the language in the specified language code.
   */
  ...
  /**
   * Determines whether the language is spoken in a given country.
   *
   * @param country The country to check.
   *
   * @return `true` if the language is spoken in the specified country, `false` otherwise.
   */
  fun isSpokenIn(country: Country): Boolean = isSpokenIn(country.code)

  /**
   * Determines whether the language is spoken in a given country code.
   *
   * @param countryCode The country code to check.
   *
   * @return `true` if the language is spoken in the specified country code, `false` otherwise.
   */
  ...
  /**
   * Determines whether the language is written in a given script.
   *
   * @param script The script to check.
   *
   * @return `true` if the language is written in the specified script, `false` otherwise.
   */
