...
/**
 * Represents a script, a writing system used to represent a language.
 *
 * @see Language
 */
sealed class Script {
  ...
  /**
   * The unique identifier code for the script.
   */
  ...
  /**
   * Indicates whether the script is written from right to left (RTL).
   */
  abstract val isRtl: Boolean

  /**
   * A list of two-letter ISO 639-1 language codes that are written in this script.
   */
